...
(() => {
  ...
  /*!
 funcion de calculo para el formulario de tickets de compra
 */
  ...
  function calcularPrecioFinal() {
    ...
    // en desc almaceno el tipo de usuario y su correspondiente descuento
    let desc = document.getElementById("porcentajeDescuento").value;
    console.log(desc);
    ...
    // resto el descuento del precio total
    let precioFinal  =  (cantEnt*1000) - descTotal;  
    console.log("precioFinal:" + precioFinal);

    // coloco en el html el valor de las entradas menos el descuento
